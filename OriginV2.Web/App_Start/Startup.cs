...
[assembly: OwinStartup(typeof(OriginV2.Web.App_Start.Startup))]
namespace OriginV2.Web.App_Start
{
    ...
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            GlobalConfiguration.Configuration.UseSqlServerStorage(OriginV2Confirguration.Instance.OriginContext);
