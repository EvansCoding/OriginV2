namespace OriginV2.Core.SiteConfig
{
    using Models.Enums;
    using OriginV2.Core.Services;
    using System.Web.Hosting;
    using System.Xml;

    public class SiteConfig
    {
        private static string ConfigLocation => HostingEnvironment.MapPath("~/App_Data/origin.config");
        ...
        {
            const string cacheKey = "originsiteconfig";
